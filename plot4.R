...
## Build and combine the plots A, B, C and D from the "reduced_data" data table.
...
# plot A
with(reduced_data, plot(cleanDateTime, Global_active_power, type ="l", xlab = "", ylab = "Global Active Power"))

# plot B
with(reduced_data, plot(cleanDateTime,Voltage, type ="l", xlab="datetime"))
...
# plot D
with(reduced_data, plot(cleanDateTime,Global_reactive_power, type ="l", xlab="datetime"))
