...
## Build plot1 from the "reduced_data" data table.
   
cat("Making plot #1")
png(file="plot1.png", width=480, height=480)

 with(reduced_data, hist(Global_active_power, col="red", breaks = 12, xlab = "Global Active Power (kilowatts)", main = "Global Active Power"))
